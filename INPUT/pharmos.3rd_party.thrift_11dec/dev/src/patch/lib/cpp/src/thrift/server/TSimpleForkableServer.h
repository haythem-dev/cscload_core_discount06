...
#ifndef _THRIFT_SERVER_TSIMPLEFORKABLESERVER_H_
#define _THRIFT_SERVER_TSIMPLEFORKABLESERVER_H_ 1
 ...
 */
class TSimpleForkableServer : public TServerFramework {
public:
  TSimpleForkableServer(
