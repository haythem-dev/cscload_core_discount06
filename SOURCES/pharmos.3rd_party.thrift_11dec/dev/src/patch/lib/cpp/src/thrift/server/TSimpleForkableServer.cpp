...
#include "TSimpleForkableServer.h"
...
TSimpleForkableServer::TSimpleForkableServer(const shared_ptr<TProcessorFactory>& processorFactory,
...
TSimpleForkableServer::TSimpleForkableServer(const shared_ptr<TProcessor>& processor,
                             const shared_ptr<TServerTransport>& serverTransport,
                             const shared_ptr<TTransportFactory>& transportFactory,
                             const shared_ptr<TProtocolFactory>& protocolFactory)
...
TSimpleForkableServer::~TSimpleForkableServer() {
}
 ...
 */
void TSimpleForkableServer::onClientConnected(const shared_ptr<TConnectedClient>& pClient) {
      pClient->run();
}
 ...
 */
void TSimpleForkableServer::onClientDisconnected(TConnectedClient*) {
      //as we are intended to be used with a forking server, we can safely exist when the client has been handled
      exit(0);
}
 ...
 */
void TSimpleForkableServer::setConcurrentClientLimit(int64_t) {
}
